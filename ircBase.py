...
class IrcBot(object):
    ...
    def cleanup(self):
        '''Closes open connections, cleans up vars, and clears shared instance'''
        if self.connection: self.connection.close()
        if self._database_connection: self._database_connection.close()
        IrcBot._instance == None
    ...
    def run(self):
        ...
        while True:
            ...
            #Catch exit request, clean up and break
            except SystemExit:
                self.cleanup()
                break

...
def main(irc):
	...
	#Weather command
	elif message.botCommand == 'weather':
		try:
			...
			irc.sendMessageToRoom("It is " + temperatureSpan.string + "F and " + currentCondition.string + ", Feels Like " + feelsLike.string + "F in " + locationName.string)
		except:
			return
